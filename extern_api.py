...
# camera()                      for capturing the photo through your eye. this return the photo name. when I instruct you to look, you can look and see, by taking a photo. To get the photo file, put attach_to_context(photo_name) in the code snippet, I'll then upload the photo to you
